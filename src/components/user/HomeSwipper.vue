...
const cardData = ref([
  {
    ...
    imgUrl: new URL('/src/img/can_lavender.png', import.meta.url).href,
    bgImgUrl: new URL('/src/img/bgImg_lavender.jpg', import.meta.url).href,
  ...
  },
  {
    ...
    imgUrl: new URL('/src/img/can_chrysanthemum.png', import.meta.url).href,
    bgImgUrl: new URL('/src/img/bgImg_chrysanthemum.jpg', import.meta.url).href,
  ...
  },
  {
    ...
    imgUrl: new URL('/src/img/can_aloe_vera.png', import.meta.url).href,
    bgImgUrl: new URL('/src/img/bgImg_aloe_vera.jpg', import.meta.url).href,
  ...
  },
  {
    ...
    content: '薰衣草特殊香氛設計，讓您彷彿沐浴在薰衣草田中，適合中乾髮質，讓您有水潤的頭髮',
    shortContent: '薰衣草香氣，適合中乾髮質',
    imgUrl: new URL('/src/img/can_bee.png', import.meta.url).href,
    bgImgUrl: new URL('/src/img/bgImg_bee.jpg', import.meta.url).href,
  ...
  },
  {
    ...
    content: '薰衣草特殊香氛設計，讓您彷彿沐浴在薰衣草田中，適合中乾髮質，讓您有水潤的頭髮',
    shortContent: '薰衣草香氣，適合中乾髮質',
    imgUrl: new URL('/src/img/can_mint.png', import.meta.url).href,
    bgImgUrl: new URL('/src/img/bgImg_mint.jpg', import.meta.url).href,
  ...
  },
  {
    ...
    content: '薰衣草特殊香氛設計，讓您彷彿沐浴在薰衣草田中，適合中乾髮質，讓您有水潤的頭髮',
    shortContent: '薰衣草香氣，適合中乾髮質',
    imgUrl: new URL('/src/img/can_lily.png', import.meta.url).href,
    bgImgUrl: new URL('/src/img/bgImg_lily.jpg', import.meta.url).href,
  ...
  },
  {
    ...
    content: '薰衣草特殊香氛設計，讓您彷彿沐浴在薰衣草田中，適合中乾髮質，讓您有水潤的頭髮',
    shortContent: '薰衣草香氣，適合中乾髮質',
    imgUrl: new URL('/src/img/can_rose.png', import.meta.url).href,
    bgImgUrl: new URL('/src/img/bgImg_rose.jpg', import.meta.url).href,
